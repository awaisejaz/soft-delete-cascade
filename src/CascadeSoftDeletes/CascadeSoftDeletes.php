...
trait CascadeSoftDeletes
{
    ...
    /**
     * add all eloquent relationship to boot cascade on tables
     *
     * @var array
     */
     ...
     *
     * @throws \App\Models\Traits\GlobalTraits\CascadeSoftDeletes\CascadeSoftDeleteException
     */
    public function validateCascadingSoftDelete()
    {
     ...
     * @return void
     */
    public function runCascadingDeletes()
    {
    ...
    protected function cascadeSoftDeletes($relationship)
    {
        ...
        foreach ($this->{$relationship}()->get() as $model) {
            $model->mergeFillable(['deleted_at']);
